...
import 'package:simplemail/screens/drawer_screen/view/social/social_controller.dart';
...
class _SocialScreenState extends State<SocialScreen> {
  late SocialController _homeController;
  ...
  void initState() {
    ...
    _homeController = Get.put(SocialController(), permanent: true);
  }
          ...
          return (homeController.isLoading &&
              ...
              : homeController.isRefreshing
                  ...
                  : RefreshIndicator(
                      ...
                      onRefresh: (() async {
                        homeController.changeRefreshing(true);
