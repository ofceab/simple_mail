...
class ForwardReplyScreen extends StatefulWidget {
  const ForwardReplyScreen({
  ...
  @override
  State<ForwardReplyScreen> createState() => _ForwardReplyScreenState();
...
class _ForwardReplyScreenState extends State<ForwardReplyScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (widget.gmailMessage != null && widget.gmailMessage.id != null) {
      ...
      await homeController.forwardGmailMessage(widget.gmailMessage.threadId!,
